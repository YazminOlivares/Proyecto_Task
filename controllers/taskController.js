...
async function getAllTasks(req, res) {
    const usuarioBuscado = req.query.usuario
    const tasks = await taskModel.getAllTasks(usuarioBuscado);
...
async function createTask(req, res) {
  const usuarioBuscado = req.query.usuario
  const newTask = await taskModel.createTask(req.body, usuarioBuscado);
...
async function getTaskById(req, res) {
  ...
  try {
    const task = await taskModel.getTaskById(id, usuarioBuscado); 
